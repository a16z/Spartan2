...
macro_rules! impl_traits {
    ...
    $order_str:literal
        ...
        impl Group for $name::Point {
            ...
            // Note: upstreaming a more efficient Mul op could lead to significant gains
            // https://github.com/zcash/pasta_curves/blob/df67e299e6644c035a213dbad369be279276919c/src/curves.rs#L580
            fn scalar_mul(
